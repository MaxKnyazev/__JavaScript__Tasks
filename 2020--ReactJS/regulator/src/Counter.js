...
// import minus from 'logo.svg'

const Counter = ({count, subCount, addCount, color}) => {
  ...
  return (
    <div className = 'app__counter'>
      <ButtonCount color = {color} clickHandler = {subCount} sign = {minus}/>
      <span>{count}</span>
      <ButtonCount color = {color} clickHandler = {addCount} sign = {plus}/>
    </div>
  )
}
